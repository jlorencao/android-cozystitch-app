package com.example.cozystitchapp.ui.signup.registration
...
class SignUpFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding.singUpButton.setOnClickListener {
    ...
    private fun signUpWithEmailAndPassword(email: String, password: String){
        ...
        _binding.singUpButton.isEnabled = false

        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(requireActivity()) { task ->

               _binding.singUpButton.isEnabled = true
                ...
                if (task.isSuccessful) {
                    ...
                    //inflate onBoarding Fragment
                    val manager = activity?.supportFragmentManager
                    manager!!.beginTransaction()
                        .replace(R.id.fragmentContainerView,OnBoardingFirstPageFragment())
                        .commit()
                } else {
