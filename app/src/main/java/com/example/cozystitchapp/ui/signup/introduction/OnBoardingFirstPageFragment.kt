 ...
 * Use the [OnBoardingFirstPageFragment.newInstance] factory method to
...
class OnBoardingFirstPageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SettingAccountFirstPageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OnBoardingFirstPageFragment().apply {
